...
The app features creats daily reminders and alerts, with an option to create reminders that are triggered on the user's home location (using Geofence and location services).
You can use reminders such as "Did you lock the door?" when you left your home and same reminder when you return. Also to feed your pet or check laundry (the user can easily enable these reminders in the settings). 

There are also reminders templates for frequent reminders that the user can easily create, e.g., pill reminders- the user can choose how many times a day to take a pill and the time, and if they want a food reminder before/after taking thier medication.
...
REmindey should help people who tend to forget some basic things they do in their daily lives and are unsure about it, never forget a thing.
...
To create an alarm, click on "Set time" and pick the desired time, if no selection is made an alarm won't trigger.

Priority: Select the priority, if choosing high and enabling the feature in the settings, high priority reminders will trigger a reminder 10 minutes after done.

Repeat: select the repeat frequency of the reminders/alerts- daily, weekly, monthly, or never. Also, you can select the end date of the repetition .
...
Important to click on "Use current location as home" to set your home address, which reminders can use as a trigger.

For example: you can enable a reminder to check if you locked the door when you leave.

You can also set a reminder when you get home to make sure you locked the door, or other built-in reminders.
