                    ...
                    .addOnCompleteListener(new OnCompleteListener<Location>() {
                        ...
                        public void onComplete(@NonNull Task<Location> task) {
                            if (task.isSuccessful() && task.getResult() != null) {
                                ...
                                Log.d("LOCATION", "onSuccess my location: lat:" + mLocation.getLatitude() + "alt: " + mLocation.getAltitude()
...
//        CharSequence text = Utils.getLocationText(mLocation);
        String text = Utils.getLocationText(mLocation);
        Geocoder geocoder = new Geocoder(getApplicationContext(), Locale.getDefault());
        Address address;
        try {
            address = geocoder.getFromLocation(mLocation.getLatitude(), mLocation.getLongitude(), 1).get(0);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                .addAction(R.mipmap.ic_launcher_repeat, getString(R.string.launch_activity),
                        activityPendingIntent)
//                .addAction(R.drawable.ic_baseline_delete_24, getString(R.string.remove_location_updates),
